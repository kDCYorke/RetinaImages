 ...
 * with ClientBundle.
 */
public class RetinaImageResourcePrototype implements RetinaImageResource {
   ...
   */
  public RetinaImageResourcePrototype(String name, SafeUri url, int left, int top, int width, int height,
      boolean animated, boolean lossy, boolean retina) {
    this.name = name;
    this.left = left;
    this.top = top;
    this.height = height;
